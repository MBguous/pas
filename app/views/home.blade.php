...
@section('content')
	...
	<div class="container">
	      		...
	      		<hr>
						...
						<div class="info-user">
							...
							{{ Form::open(array('route' => 'attendances.store')) }}
								{{ Form::hidden('date', $d, ['class'=>"form-control", 'placeholder'=>"todays date"]) }}
								{{ Form::hidden('clock_in', $t) }}
								<button type="submit" class="btn btn-primary">Clock In</button>
							{{ Form::close() }}
							
							<!-- clock out button -->
							<a href="#clock-out" class="btn btn-warning" data-toggle="modal" data-target=".bs-example-modal-sm">Clock Out</a>
							<div class="modal fade bs-example-modal-sm" id="clock-out">
								<div class="modal-dialog">
									<div class="modal-content">
										...
										<div class="modal-body">
											<p>Are you sure want to clock out?</p>
										</div>
										<div class="modal-footer">
											{{ Form::open(array('action' => 'AttendancesController@update', 'method' => 'put')) }}
												{{ Form::hidden('date', $d, ['class'=>"form-control", 'placeholder'=>"todays date"]) }}
												{{ Form::hidden('clock_in', $t) }}
      		...
      		<div class="half-unit">
	      		...
	      		<hr>
		      		<div class="clockcenter">
			      		...
			      		<span class="label label-danger">Clocked Out</span>
		      		</div>
      ...
      <!-- SERVER UPTIME -->
			<div class="half-unit">
	      		<dtitle>Year-to-Date Payroll Cost</dtitle>
	      		<hr>
	      		<div class="cont">
					<p><img src="assets/img/up.png" alt=""> <bold>Rs. 434555.67</bold></p>
				</div>
			</div>
